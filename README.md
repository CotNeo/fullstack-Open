...
```
fullstack-Open/
├── Course Requirement JavaScript Fundamentals/    # JavaScript core concepts
├── Course Requirement Data Structures and Algorithms/  # DSA fundamentals
├── Part_0/                                        # Course introduction
├── Part_1/                                         # React fundamentals
├── Part_2/                                         # Communicating with server
├── Part_3/                                         # Programming a server with NodeJS and Express
├── Part_4/                                         # Testing Express servers, and user administration
├── Part_5/                                         # Testing React apps
├── Part_6/                                         # Advanced state management
├── Part_7/                                         # React router, custom hooks, styling app with CSS and webpack
├── Part_8/                                         # GraphQL
├── Part_9/                                         # TypeScript full-stack development
└── README.md                                       # This file
```
...
2. **Install dependencies for specific parts**:
   ```bash
   # For Part 9 (TypeScript full-stack)
   cd Part_9/server/patientor-backend
   npm install
   
   cd ../../client/patientor-frontend
   npm install
   ```
...
3. **Start development**:
   ...
   # Frontend (Terminal 2)
   cd Part_9/client/patientor-frontend
   npm run dev
   ```
